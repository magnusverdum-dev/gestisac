...
pub fn router(state: AppState) -> Router {
    Router::new()
        ...
        .route(
            "/api/condominiums/quick",
            post(condominiums::create_condominium_quick),
        )
        .route(
        ...
        .route(
            ...
            put(condominiums::update_condominium_identification),
        )
        .route(
            "/api/condominiums/{id}/address",
            put(condominiums::update_condominium_address),
        )
        .route(
            "/api/condominiums/{id}/structure",
            put(condominiums::update_condominium_structure),
        )
        .route(
            "/api/condominiums/{id}/operational-status",
            put(condominiums::update_condominium_operational_status),
        )
        .route(
        ...
        .route(
            ...
            get(condominiums::list_condominium_blocks).post(condominiums::create_condominium_block),
        )
        .route(
            "/api/condominiums/{id}/blocks/{block_id}",
            put(condominiums::update_condominium_block)
                .delete(condominiums::delete_condominium_block),
        )
        .route(
            "/api/condominiums/{id}/floors",
            get(condominiums::list_condominium_floors).post(condominiums::create_condominium_floor),
        )
        .route(
            "/api/condominiums/{id}/floors/{floor_id}",
            put(condominiums::update_condominium_floor)
                .delete(condominiums::delete_condominium_floor),
        )
        .route(
            "/api/condominiums/{id}/zones",
            get(condominiums::list_condominium_zones).post(condominiums::create_condominium_zone),
        )
        .route(
            "/api/condominiums/{id}/zones/{zone_id}",
            put(condominiums::update_condominium_zone)
                .delete(condominiums::delete_condominium_zone),
        )
        .route(
            "/api/condominiums/{id}/equipment",
            get(condominiums::list_condominium_equipment)
                .post(condominiums::create_condominium_equipment),
        )
        .route(
            "/api/condominiums/{id}/equipment/{equipment_id}",
        ...
        .route(
            ...
            get(condominiums::list_condominium_contacts)
                .post(condominiums::create_condominium_contact),
        )
        .route(
            "/api/condominiums/{id}/contacts/{contact_id}",
            put(condominiums::update_condominium_contact)
                .delete(condominiums::delete_condominium_contact),
        )
        .route(
            "/api/condominiums/{id}/documents",
            get(condominiums::list_condominium_documents)
        ...
        .route(
            "/api/condominiums/{id}/documents/{document_id}",
            put(condominiums::update_condominium_document)
                .delete(condominiums::delete_condominium_document),
        )
        .route(
            "/api/condominiums/{id}/media",
            get(condominiums::list_condominium_media).post(condominiums::create_condominium_media),
        )
        .route(
        ...
        .route(
            "/api/condominiums/{id}/media/{media_id}",
            put(condominiums::update_condominium_media)
                .delete(condominiums::delete_condominium_media),
        )
        .route(
            "/api/condominiums/{id}/notes",
            get(condominiums::list_condominium_notes).post(condominiums::create_condominium_note),
        )
        .route(
            "/api/condominiums/{id}/notes/{note_id}",
