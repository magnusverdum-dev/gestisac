...
export const useClientCondominiumsData = routeLoader$<LoaderReturn>(
...
export default component$(() => {
  const loaderSignal = useClientCondominiumsData();
